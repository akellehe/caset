...
class CustomCleanCommand(CleanCommand):
    def run(self):
        ...
        clean_dirs = ['.eggs', 'build', 'dist', '__pycache__', 'caset.egg-info', 'caset.egg-info',
                      'cmake-build-debug']
...
resp = setup(
    ...
    url="https://github.com/CANOLDLLC/caset",
    ...
    setup_requires=["pytest-runner",
                    ...
                    "cmake",
                    "pybind11"],
    ext_modules=[CMakeExtension("caset", sourcedir=".")],
    zip_safe=False,
    install_requires=[
        "Jinja2==3.1.2",
        "PyYAML==6.0.1",
