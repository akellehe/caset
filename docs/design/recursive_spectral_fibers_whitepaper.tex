...
is carried as its own field, and it twists the hopping rather than rescaling
the weight.
...
A gauge transformation must act on the twisted operator by conjugation, leaving
its spectrum fixed and the geometry untouched. Saying that an edge
