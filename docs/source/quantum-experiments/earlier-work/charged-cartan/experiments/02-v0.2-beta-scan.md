...
> **Status**: complete (the headline 4D-ish result)
> **Design**: [v0.2 qudit-basis](../design/v0.2.md)
> **Result**: peak D_S = 4.6 ± 0.1 across a full decade of β at γ_CP = 0 — the first stable D_S plateau in this project. Finite-size follow-up in [Experiment 03](03-v0.2-finite-size.md).
