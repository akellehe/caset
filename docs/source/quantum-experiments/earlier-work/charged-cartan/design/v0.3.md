# Charged Cartan Monte Carlo — v0.3 design: gauge mediation

> **Status**: designed, not yet implemented
> **Builds on**: [v0.1 design](v0.1.md), [v0.2 design](v0.2.md)
> **Milestone**: [Charged Cartan Monte Carlo v0.3](https://github.com/akellehe/tessera/milestone/2) — tracks #17 (implementation), #18 (Coulomb fidelity), #19 (photon-density / plateau survival)
