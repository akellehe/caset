...
investigation](../earlier-work/charged-cartan/experiments/03-v0.2-finite-size.md) surfaces as a real
...
- **Gauge force as photon-mediated correlation** is what
  [v0.3](../earlier-work/charged-cartan/design/v0.3.md) implements: between two
...
The v0.2 β-scan ([writeup](../earlier-work/charged-cartan/experiments/02-v0.2-beta-scan.md))
finds a stable plateau at peak `D_S ≈ 4.6 ± 0.1` across a decade of
`β`. The [finite-size
investigation](../earlier-work/charged-cartan/experiments/03-v0.2-finite-size.md) then shows that this
...
- The construction's own design notes:
  [v0.1](../earlier-work/charged-cartan/design/v0.1.md),
  [v0.2](../earlier-work/charged-cartan/design/v0.2.md),
  [v0.3](../earlier-work/charged-cartan/design/v0.3.md).
