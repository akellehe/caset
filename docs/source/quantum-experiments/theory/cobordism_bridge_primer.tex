...
Every claim in this primer is phrased through one symbol, $\geo(\cdot)$, and the
rest of the document never pauses to say what it is. We fix it here, before its
first use. Informally, $\geo$ is the \emph{realization} (synthesis) map that
