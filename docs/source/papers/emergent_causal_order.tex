...
\begin{itemize}[nosep]
  \item \emph{Total $U(1)$ charge conservation}: the staggered
        fermion number $\sum_n \tfrac{1 - (-1)^n Z_n}{2}$ commutes
        with $H$.  We restrict to the half-filling sector, which
        contains the physical vacuum.
...
\begin{itemize}[nosep]
  \item \texttt{examples/quantum/phase5\_scan.py}, and
  \item \texttt{examples/quantum/phase5\_scan\_strong\_falsification.py}.
\end{itemize}
...
\ref{tab:strong} are
\texttt{examples/quantum/phase5\_scan.py} and
\texttt{examples/quantum/phase5\_scan\_strong\_falsification.py}.}
