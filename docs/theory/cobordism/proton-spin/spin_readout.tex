...
(scoped in the codebase as the open follow--up; design note
\code{docs/design/total\_space\_spin\_operator\_design.md}).
...
measuring stick, \#489) and \code{docs/design/total\_space\_spin\_operator\_design.md}
(the planned resolution, \#495/\#477).
